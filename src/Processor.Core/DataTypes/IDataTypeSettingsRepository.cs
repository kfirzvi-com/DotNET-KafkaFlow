...
/// <summary>
/// Read surface over data-type settings, consumed by the message path. Implementations decide how the
/// data is stored and whether it is cached; callers only deal with the query surface.
/// </summary>
